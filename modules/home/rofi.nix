  ...
  programs.rofi = {
    ...
    in {
      "*" = {
        ...
        common-background-66 = mkLiteral "@black-66";
      ...
      "window" = {
        background-color = mkLiteral "#1d1f21e6";
        border = 3;
      ...
      "inputbar" = {
        background-color = mkLiteral "#333537";
        border = 1;
        border-color = mkLiteral "#606263";
        border-radius = 8;
